...
# ฟังก์ชันเดินตรงตามแกนด้วย P-Control
def move_straight(ep_chassis, axis='x', distance=1.2):
    global current_x, current_y
    print(f"Moving {distance} meters on {axis.upper()} axis using P-Control...")
    ...
    while True:
        ...
        print(f"Error: {error:.3f}, Speed: {speed:.3f}")
        time.sleep(dt)
...
if __name__ == '__main__':
    ...
    try:
        print("== Start Square Movement (P-Control) ==")
